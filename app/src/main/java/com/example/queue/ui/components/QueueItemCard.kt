        ...
        Column {
            Row {
                Column(modifier = Modifier
                    ...
                    .weight(1f)) {
                    Text(text = queue.name, style = MaterialTheme.typography.titleLarge,
                    ...
                    Text(text = "Участников: ${queue.members.size}", style = MaterialTheme.typography.bodyMedium)
                }
...
fun QueueIndicator(ableText: String, unableText: String, isStatus: Boolean){
    ...
    Surface(
        ...
        modifier = Modifier
            .animateContentSize()
            .padding(8.dp).border(2.dp, Color.White, MaterialTheme.shapes.extraLarge)
    ){
        Text(
